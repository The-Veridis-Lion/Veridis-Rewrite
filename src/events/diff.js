 ...
 */
import { extensionName, getAppContext, runtimeState, minTrackedDiffMessages, maxTrackedDiffMessages, normalizeDiffTrackedMessageLimit } from '../state.js';
import {
    openSingleRuleModal,
    openEditModal,
    showToast,
...
import { clearTrackedDiffEntry, escapeHtml, getDiffComparisonForMessage, getDiffSnippetsForMessage, getDiffStateForMessage, injectDiffButtons, refreshDiffCacheIfStale, syncTrackedIndicesToLatestAssistantMessages } from '../diff.js';
...
import { buildCurrentProgramFallbackTextForMessage, requestManualAiRewriteForMessage } from '../aiRewrite.js';
...
export function recleanseDiffMessageAtIndex(index) {
    ...
    const recleanseText = buildCurrentProgramFallbackTextForMessage(sourceMes, msg);
