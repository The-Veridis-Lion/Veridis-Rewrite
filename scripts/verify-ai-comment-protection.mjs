...
const aiRewriteSource = fs.readFileSync(path.join(repoRoot, 'src', 'aiRewrite', 'runtime.js'), 'utf8');
const templateSource = fs.readFileSync(path.join(repoRoot, 'templates', 'purifier.html'), 'utf8');
const eventsSource = fs.readFileSync(path.join(repoRoot, 'src', 'events', 'aiSettings.js'), 'utf8');
